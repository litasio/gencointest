...
#if defined(NDEBUG)
# error "Gencoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x9f4a501bc62255b0de48345333aed08271fc52cf409a95fe53f9a6781fe71027");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Gencoin: starting difficulty is 1 / 2^12
...
{
    // Gencoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Gencoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Gencoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Gencoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Gencoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Gencoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9f4a501bc62255b0de48345333aed08271fc52cf409a95fe53f9a6781fe71027");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Gencoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("223040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1528199038;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1351915;
        ...
        assert(block.hashMerkleRoot == uint256("0x88e55898b9e915ade6c38c4aad18c0737c295df0dd0c1e1b64aa100c03c4c704"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Gencoin: increase each by adding 2 to bitcoin's value.
...
void static GencoinMiner(CWallet *pwallet)
{
    ...
    {
        printf("GencoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&GencoinMiner, pwallet));
}
